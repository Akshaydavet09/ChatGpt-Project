...
function Sidebar() {
    ...
    const { data, setData, prevChats, setPrevChats, newChat, setNewChat, newThreadId, setNewThreadId, uuidv4, latestReply, setLatestReply, reply, setReply } = useContext(MyContext);
    useEffect(() => {
